...
describe('Function 테스트', () => {
    ...
    it('함수에는 기본적으로 정의되고 할당되어있는 프로퍼티들이 존재한다.', () => {
        function add(a, b) {
            return a + b;
        }
    ...
    it('Function.protoype.apply 함수 테스트', () => {
        let obj = {
            value: 10,
            getValue: function () {
                return this.value;
